  ...
  return (
    <section className="relative h-screen flex flex-col items-center justify-center overflow-hidden">
      <div className="text-center z-10 max-w-4xl px-6 flex-grow flex flex-col justify-center">
        <h1 className="text-4xl md:text-6xl font-bold mb-6 leading-tight md:text-6xl text-3xl">
          Where <span className="text-white/50">Fashion</span> Meets <br />
          Digital Elevation
        </h1>
        <p className="text-lg md:text-xl text-white/50 mb-12 max-w-2xl mx-auto md:text-xl text-base">
      ...
      <div className="z-10 pb-16 animate-pulse">
